...
$sql  = "INSERT INTO content (content_name, content_type, content_image, content_path, content_description, admin_id) VALUES (?, ?, ?, ?, ?, ?)";
$stmt = mysqli_prepare($conn, $sql);
mysqli_stmt_bind_param($stmt, "sssssi", $content_name, $content_type, $image_path, $content_path, $content_description, $admin_id);
